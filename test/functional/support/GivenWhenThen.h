...
#define GIVEN(Steps, Description) GIVEN_(Steps, STEPNAME(Steps, _Given, __LINE__), Description)
...
#define WHEN(Steps, Description) WHEN_(Steps, STEPNAME(Steps, _When, __LINE__), Description)
...
#define THEN(Steps, Description) THEN_(Steps, STEPNAME(Steps, _Then, __LINE__), Description)
