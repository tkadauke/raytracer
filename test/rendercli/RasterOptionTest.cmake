...
if(opengl_shadow_trace_result STREQUAL "0")
  ...
  if(NOT opengl_shadow_trace_json MATCHES "OpenGL raster shadow sampling")
    _rendercli_fail("rendercli --raster_backend gpu shadow trace"
                    "OpenGL shadow-map trace did not record shader-side sampling eligibility"
                    "" "${opengl_shadow_trace_result}" "${opengl_shadow_trace_stdout}"
                    "${opengl_shadow_trace_json}")
  endif()
  if(NOT opengl_shadow_trace_json MATCHES "OpenGL raster shadow sampling uses shader-side binding")
    _rendercli_fail("rendercli --raster_backend gpu shadow trace"
                    "OpenGL shadow-map trace did not record shader-side sampling execution"
                    "" "${opengl_shadow_trace_result}" "${opengl_shadow_trace_stdout}"
                    "${opengl_shadow_trace_json}")
  endif()
