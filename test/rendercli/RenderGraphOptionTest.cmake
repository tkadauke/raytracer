...
if(NOT wavefront_metrics_stdout MATCHES "resident_direct_light_round_trips_estimate=")
  _rendercli_fail("rendercli wavefront metrics resident direct-light round-trip summary"
                  "wavefront metrics summary did not contain resident direct-light round trips"
                  "${wavefront_metrics_stdout}" "" "" "")
endif()
if(NOT wavefront_metrics_stdout MATCHES "resident_direct_light_round_trip_savings_estimate=")
  _rendercli_fail("rendercli wavefront metrics resident direct-light saving summary"
                  "wavefront metrics summary did not contain resident direct-light savings"
                  "${wavefront_metrics_stdout}" "" "" "")
endif()
...
if(NOT wavefront_metrics_stdout MATCHES "last_direct_light_any_hit_frontier_packed_ray_bytes=")
...
if(NOT wavefront_metrics_stdout MATCHES "last_direct_light_any_hit_frontier_host_query_bytes=")
  _rendercli_fail("rendercli wavefront metrics last direct-light any-hit host query bytes summary"
                  "wavefront metrics summary did not contain last direct-light any-hit host query bytes"
                  "${wavefront_metrics_stdout}" "" "" "")
endif()
if(NOT wavefront_metrics_stdout MATCHES "last_direct_light_any_hit_frontier_state_handle_bytes=")
  _rendercli_fail("rendercli wavefront metrics last direct-light any-hit state handle bytes summary"
                  "wavefront metrics summary did not contain last direct-light any-hit state handle bytes"
                  "${wavefront_metrics_stdout}" "" "" "")
endif()
...
foreach(expectation
  ...
  if(NOT wavefront_metrics_json MATCHES "${expectation}")
    _rendercli_fail("rendercli wavefront tracing capability JSON ${expectation}"
                    "wavefront metrics report did not contain tracing capability field"
                    "" "" "${wavefront_metrics_json}" "")
  endif()
endforeach()
...
if(NOT wavefront_metrics_json MATCHES "\"intersectionEstimatedClosestHitQueryTransferBytes\"")
  _rendercli_fail("rendercli wavefront metrics closest-hit transfer bytes"
                  "wavefront metrics report did not contain closest-hit transfer byte estimate"
                  "" "" "${wavefront_metrics_json}" "")
endif()
if(NOT wavefront_metrics_json MATCHES "\"intersectionEstimatedAnyHitQueryTransferBytes\"")
  _rendercli_fail("rendercli wavefront metrics any-hit transfer bytes"
                  "wavefront metrics report did not contain any-hit transfer byte estimate"
                  "" "" "${wavefront_metrics_json}" "")
endif()
...
if(NOT wavefront_metrics_stdout MATCHES "frontier_compaction_moved_retained_fraction=")
  _rendercli_fail(
    "rendercli wavefront metrics frontier compaction moved retained fraction summary"
    "wavefront metrics summary did not contain frontier compaction moved retained fraction"
    "${wavefront_metrics_stdout}" "" "" "")
endif()
...
if(NOT wavefront_metrics_stdout MATCHES "frontier_largest_compaction_candidate_depth=")
  _rendercli_fail("rendercli wavefront metrics largest compaction candidate depth summary"
                  "wavefront metrics summary did not contain largest compaction candidate depth"
                  "${wavefront_metrics_stdout}" "" "" "")
endif()
...
foreach(direct_light_any_hit_field
        ...
        directLightOcclusionHostBytes
        directLightOcclusionHostBytesPerDepth
        directLightContributionHostBytes
  ...
  if(NOT wavefront_metrics_json MATCHES "\"${direct_light_any_hit_field}\"")
    _rendercli_fail("rendercli wavefront metrics ${direct_light_any_hit_field}"
                    "wavefront metrics report did not contain ${direct_light_any_hit_field}"
                    "" "" "${wavefront_metrics_json}" "")
  endif()
endforeach()
...
foreach(expectation
        ...
        "tracing_scene_compiled=true"
        "tracing_scene_materials=[0-9][0-9]*"
        "tracing_scene_textures=[0-9][0-9]*"
        "tracing_scene_lights=[0-9][0-9]*"
        "tracing_scene_upload_bytes=[0-9][0-9]*"
...
foreach(expectation
        ...
        "\"tracingSceneMaterials\"[ \r\n]*:[ \r\n]*[0-9][0-9]*"
        "\"tracingSceneTextures\"[ \r\n]*:[ \r\n]*[0-9][0-9]*"
        "\"tracingSceneLights\"[ \r\n]*:[ \r\n]*[0-9][0-9]*"
        "\"tracingSceneUploadBytes\"[ \r\n]*:[ \r\n]*[0-9][0-9]*"
...
foreach(expectation
        ...
        "tracing_scene_textures=[1-9][0-9]*"
        "tracing_scene_lights=[0-9][0-9]*"
        "tracing_scene_unsupported_materials=0"
        "tracing_scene_unsupported_textures=0"
        "tracing_scene_unsupported_lights=0"
        "tracing_scene_upload_bytes=[1-9][0-9]*"
...
foreach(expectation
        ...
        "\"tracingSceneUnsupportedMaterialReasons\""
        "\"tracingSceneUnsupportedTextureReasons\""
        "\"tracingSceneUnsupportedLightReasons\""
        "\"tracingSceneUploadBytes\"[ \r\n]*:[ \r\n]*[1-9][0-9]*"
