...
foreach(expectation
        ...
        "intersection_backend_fallback=(none|Metal_wavefront_intersection_backend.*|Vulkan_wavefront_intersection_backend.*)"
...
foreach(expectation
        ...
        "\"intersectionBackend\"[ \r\n]*:[ \r\n]*\"(cpu|metal|vulkan)\""
        "\"intersectionBackendAvailability\"[ \r\n]*:[ \r\n]*\"(fallback|available)\""
        "\"intersectionBackendFallbackReason\"[ \r\n]*:[ \r\n]*\"(|Metal wavefront intersection backend[^\"]*|Vulkan wavefront intersection backend[^\"]*)\""
