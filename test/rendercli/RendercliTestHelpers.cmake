...
function(_rendercli_probe_image path output_variable)
  ...
  if(NOT stdout MATCHES "^width=([0-9]+) height=([0-9]+) nonzero_pixels=([0-9]+) unique_colors=([0-9]+) hash=([0-9a-f]+)$")
...
function(rendercli_probe_image path)
  set(one_value_args NAME OUTPUT_VARIABLE WIDTH_VARIABLE HEIGHT_VARIABLE NONZERO_PIXELS_VARIABLE UNIQUE_COLORS_VARIABLE HASH_VARIABLE)
  cmake_parse_arguments(ARG "" "${one_value_args}" "" ${ARGN})
  if(ARG_UNPARSED_ARGUMENTS)
