...
namespace testing {
  namespace internal {
    ...
    AssertionResult TypesEqualPredFormat(const char* expr1, const char* expr2, const S&, const T&) {
      if (TypesEqual<S, T>::Value)
        return AssertionSuccess();

      Message msg;
      msg << "The types of " << expr1 << " and " << expr2 << " were not equal";
