...
namespace AngleTest {
  ...
  TYPED_TEST(AngleTest, ShouldCompareAngles) {
    auto angle1 = Angle<TypeParam>::fromDegrees(90), angle2 = Angle<TypeParam>::fromDegrees(90);
    ASSERT_TRUE(angle1 == angle2);
  }

  TYPED_TEST(AngleTest, ShouldCompareAnglesForInequality) {
    auto angle1 = Angle<TypeParam>::fromDegrees(90), angle2 = Angle<TypeParam>::fromDegrees(180);
    ASSERT_TRUE(angle1 != angle2);
  }
