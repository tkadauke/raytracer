...
namespace BoundingBoxTest {
  ...
  TYPED_TEST(BoundingBoxTest, ShouldCompareDifferentInstancesForEquality) {
    BoundingBox<TypeParam> bbox1(Vector3<TypeParam>(-1, -1, -1), Vector3<TypeParam>(1, 1, 1));
    BoundingBox<TypeParam> bbox2(Vector3<TypeParam>(-1, -1, -1), Vector3<TypeParam>(1, 1, 1));
    ASSERT_TRUE(bbox1 == bbox2);
  }

  TYPED_TEST(BoundingBoxTest, ShouldCompareDifferingInstancesForEquality) {
    BoundingBox<TypeParam> bbox1(Vector3<TypeParam>(-1, -1, -1), Vector3<TypeParam>(1, 1, 1));
    BoundingBox<TypeParam> bbox2(Vector3<TypeParam>(0, 0, 0), Vector3<TypeParam>(1, 1, 1));
  ...
  TYPED_TEST(BoundingBoxTest, ShouldIncludeOverlappingBoundingBoxes) {
    BoundingBox<TypeParam> bbox1(Vector3<TypeParam>(-1, -1, -1), Vector3<TypeParam>(1, 1, 1));
    BoundingBox<TypeParam> bbox2(Vector3<TypeParam>(0, 0, 0), Vector3<TypeParam>(2, 2, 2));

    BoundingBox<TypeParam> expected(Vector3<TypeParam>(-1, -1, -1), Vector3<TypeParam>(2, 2, 2));

    ASSERT_EQ(expected, bbox1 | bbox2);
  }

  TYPED_TEST(BoundingBoxTest, ShouldIncludeInsideBoundingBoxes) {
    BoundingBox<TypeParam> bbox1(Vector3<TypeParam>(-2, -2, -2), Vector3<TypeParam>(2, 2, 2));
    BoundingBox<TypeParam> bbox2(Vector3<TypeParam>(-1, -1, -1), Vector3<TypeParam>(1, 1, 1));
  ...
  TYPED_TEST(BoundingBoxTest, ShouldIncludeOutsideBoundingBoxes) {
    BoundingBox<TypeParam> bbox1(Vector3<TypeParam>(-2, -2, -2), Vector3<TypeParam>(-1, -1, -1));
    BoundingBox<TypeParam> bbox2(Vector3<TypeParam>(0, 0, 0), Vector3<TypeParam>(1, 1, 1));

    BoundingBox<TypeParam> expected(Vector3<TypeParam>(-2, -2, -2), Vector3<TypeParam>(1, 1, 1));
  ...
  TYPED_TEST(BoundingBoxTest, ShouldIntersectOverlappingBoundingBoxes) {
    ...
    BoundingBox<TypeParam> expected(Vector3<TypeParam>(0, 0, 0), Vector3<TypeParam>(1, 1, 1));
  ...
  TYPED_TEST(BoundingBoxTest, ShouldNotBeInfiniteForNormalBoundingBox) {
    BoundingBox<TypeParam> bbox(Vector3<TypeParam>(0, 0, 0), Vector3<TypeParam>(1, 1, 1));
  ...
  TYPED_TEST(BoundingBoxTest, ShouldGrowBoundingBox) {
    BoundingBox<TypeParam> bbox(Vector3<TypeParam>(-1, -1, -1), Vector3<TypeParam>(1, 1, 1));
    BoundingBox<TypeParam> expected(Vector3<TypeParam>(-2, -2, -2), Vector3<TypeParam>(2, 2, 2));
  ...
  TYPED_TEST(BoundingBoxTest, ShouldMoveBoundingBox) {
    BoundingBox<TypeParam> bbox(Vector3<TypeParam>(-1, -1, -1), Vector3<TypeParam>(1, 1, 1));
    BoundingBox<TypeParam> expected(Vector3<TypeParam>(0, 0, 0), Vector3<TypeParam>(2, 2, 2));
  ...
  TYPED_TEST(BoundingBoxTest, ShouldComputeMinkowskiSum) {
    BoundingBox<TypeParam> bbox1(Vector3<TypeParam>(-1, -1, -1), Vector3<TypeParam>(1, 1, 1));
    BoundingBox<TypeParam> bbox2(Vector3<TypeParam>(-2, -3, -1), Vector3<TypeParam>(1, 3, 2));
    BoundingBox<TypeParam> expected(Vector3<TypeParam>(-3, -4, -2), Vector3<TypeParam>(2, 4, 3));
  ...
  TYPED_TEST(BoundingBoxTest, ShouldReturnVerticesInStableCornerOrder) {
    BoundingBox<TypeParam> bbox(Vector3<TypeParam>(-1, -2, -3), Vector3<TypeParam>(4, 5, 6));
