...
- Extend the restricted Metal full-GPU diffuse path-loop subset to support
  untransformed triangle/sphere/plane/rectangle/disk Matte/Emissive scenes,
  letting ordinary floor and mesh-like setups enter the GPU-owned path loop
  instead of being rejected before dispatch. — GPT-5 Codex
