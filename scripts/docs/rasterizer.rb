    ...
    rectangle :position => [-3.5, 1.05, -2.45],
              ...
              :material => matte_material(
                :diffuseTexture => checker_board_texture(
                  :uScale => 1.25,
                  :vScale => 1.25,
                  :brightTexture => constant_color_texture(:color => [0.78, 0.76, 0.68]),
                  :darkTexture => constant_color_texture(:color => [0.24, 0.27, 0.30]),
                ),
    ...
    box :size => [0.88, 0.92, 0.88],
        ...
        :material => matte_material(
          :diffuseTexture => checker_board_texture(
            ...
            :uScale => 5.0,
            :vScale => 5.0,
            :brightTexture => constant_color_texture(:color => [0.10, 0.70, 0.28]),
            :darkTexture => constant_color_texture(:color => [0.04, 0.28, 0.12]),
          ),
