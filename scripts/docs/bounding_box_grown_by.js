class BoundingBoxGrownBy {
  ...
  createCanvas() {
    ...
    canvas.add(new Line(this.topleft.plus(new Vector(this.size.x, 0)),
                        new Vector(this.vector.x, -this.vector.y), 'arrow red'));
    canvas.add(new Line(this.topleft.plus(new Vector(0, this.size.y)),
                        new Vector(-this.vector.x, this.vector.y), 'arrow'));
    ...
    // plot grown box
    canvas.add(new Rectangle(this.topleft.minus(this.vector),
                             this.size.plus(this.vector.multiply(2))));
