    ...
    m_blue(Colord(0, 0, 1))
{
  ...
  Triangle* triangle1 = new Triangle(Vector3d(0, 1, 0), Vector3d(1, 1, 0), Vector3d(0, 0, 0));
  triangle1->setMaterial(&m_red);
  add(triangle1);
...
static bool dummy = SceneFactory::self().registerClass<TriangleScene>("Triangle");
