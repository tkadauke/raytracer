...
def wavefront_metric_values(path)
  ...
  document.fetch("runs").each do |run|
    run_values = {
      ...
      active_host_path_state_bytes: 0.0,
      last_active_host_path_state_bytes: 0.0,
      last_retained_host_path_state_bytes: 0.0,
      ...
      direct_light_any_hit_round_trips: 0.0,
      ...
      direct_light_occlusion_host_bytes: 0.0,
      direct_light_contribution_host_bytes: 0.0,
      direct_light_any_hit_frontier_packed_ray_bytes: 0.0,
      direct_light_any_hit_frontier_host_packed_ray_bytes: 0.0,
      direct_light_any_hit_frontier_host_query_bytes: 0.0,
      direct_light_any_hit_frontier_state_handle_bytes: 0.0,
      direct_light_any_hit_frontier_last_packed_ray_bytes: 0.0,
      direct_light_any_hit_frontier_last_host_packed_ray_bytes: 0.0,
      direct_light_any_hit_frontier_last_host_query_bytes: 0.0,
      direct_light_any_hit_frontier_last_state_handle_bytes: 0.0,
      ...
      closest_hit_ray_upload_bytes: 0.0,
      any_hit_ray_upload_bytes: 0.0,
      closest_hit_query_transfer_bytes: 0.0,
      any_hit_query_transfer_bytes: 0.0,
      closest_hit_frontier_residency: [],
      any_hit_frontier_residency: [],
      closest_hit_frontier_packed_ray_bytes: 0.0,
      any_hit_frontier_packed_ray_bytes: 0.0,
      closest_hit_frontier_host_packed_ray_bytes: 0.0,
      any_hit_frontier_host_packed_ray_bytes: 0.0,
      closest_hit_frontier_host_query_bytes: 0.0,
      any_hit_frontier_host_query_bytes: 0.0,
      closest_hit_frontier_state_handle_bytes: 0.0,
      ...
      frontier_compaction_passes: 0.0,
      frontier_compaction_input_samples: 0.0,
      frontier_compaction_retained_samples: 0.0,
      frontier_compaction_removed_samples: 0.0,
      ...
      frontier_largest_compaction_candidate_host_path_state_bytes: 0.0,
    ...
    batchings.compact.each do |batching|
      ...
      run_values[:active_host_path_state_bytes] +=
        batching.fetch("activeHostPathStateBytesProcessed", 0).to_f
      active_host_path_state_bytes = batching.fetch("activeHostPathStateBytesPerDepth", [])
      unless active_host_path_state_bytes.empty?
        run_values[:last_active_host_path_state_bytes] +=
          active_host_path_state_bytes.last.to_f
      end
      retained_host_path_state_bytes =
        batching.fetch("retainedHostPathStateBytesPerDepth", [])
      unless retained_host_path_state_bytes.empty?
        run_values[:last_retained_host_path_state_bytes] +=
          retained_host_path_state_bytes.last.to_f
      end
      run_values[:active_hit_host_bytes] += batching.fetch("activeHitHostBytesProcessed", 0).to_f
      run_values[:spawned_continuations] +=
      ...
      run_values[:direct_light_any_hit_round_trips] +=
        batching.fetch("directLightAnyHitQueryRoundTrips", 0).to_f
      run_values[:resident_direct_light_round_trips_estimate] +=
        batching.fetch("residentDirectLightBatchRoundTripsEstimate", 0).to_f
      run_values[:resident_direct_light_round_trip_savings_estimate] +=
      ...
      run_values[:direct_light_occlusion_host_bytes] +=
        batching.fetch("directLightOcclusionHostBytes", 0).to_f
      ...
      run_values[:direct_light_any_hit_frontier_host_packed_ray_bytes] +=
        batching.fetch("directLightAnyHitFrontierHostPackedRayBytes", 0).to_f
      run_values[:direct_light_any_hit_frontier_host_query_bytes] +=
        batching.fetch("directLightAnyHitFrontierHostQueryBytes", 0).to_f
      run_values[:direct_light_any_hit_frontier_state_handle_bytes] +=
        batching.fetch("directLightAnyHitFrontierStateHandleBytes", 0).to_f
      direct_light_packed_ray_bytes =
        batching.fetch("directLightAnyHitFrontierPackedRayBytesPerDepth", [])
      unless direct_light_packed_ray_bytes.empty?
        run_values[:direct_light_any_hit_frontier_last_packed_ray_bytes] +=
          direct_light_packed_ray_bytes.last.to_f
      end
      direct_light_host_packed_ray_bytes =
        batching.fetch("directLightAnyHitFrontierHostPackedRayBytesPerDepth", [])
      unless direct_light_host_packed_ray_bytes.empty?
        run_values[:direct_light_any_hit_frontier_last_host_packed_ray_bytes] +=
          direct_light_host_packed_ray_bytes.last.to_f
      end
      direct_light_host_query_bytes =
        batching.fetch("directLightAnyHitFrontierHostQueryBytesPerDepth", [])
      unless direct_light_host_query_bytes.empty?
        run_values[:direct_light_any_hit_frontier_last_host_query_bytes] +=
          direct_light_host_query_bytes.last.to_f
      end
      direct_light_state_handle_bytes =
        batching.fetch("directLightAnyHitFrontierStateHandleBytesPerDepth", [])
      unless direct_light_state_handle_bytes.empty?
        run_values[:direct_light_any_hit_frontier_last_state_handle_bytes] +=
          direct_light_state_handle_bytes.last.to_f
      end
      ...
      run_values[:closest_hit_ray_upload_bytes] +=
        batching.fetch("intersectionEstimatedClosestHitRayUploadBytes", 0).to_f
      run_values[:any_hit_ray_upload_bytes] +=
        batching.fetch("intersectionEstimatedAnyHitRayUploadBytes", 0).to_f
      run_values[:closest_hit_query_transfer_bytes] +=
        batching.fetch("intersectionEstimatedClosestHitQueryTransferBytes", 0).to_f
      run_values[:any_hit_query_transfer_bytes] +=
        batching.fetch("intersectionEstimatedAnyHitQueryTransferBytes", 0).to_f
      ...
      run_values[:closest_hit_frontier_host_packed_ray_bytes] +=
        batching.fetch("intersectionBackendClosestHitFrontierHostPackedRayBytes", 0).to_f
      run_values[:any_hit_frontier_host_packed_ray_bytes] +=
        batching.fetch("intersectionBackendAnyHitFrontierHostPackedRayBytes", 0).to_f
      run_values[:closest_hit_frontier_host_query_bytes] +=
        batching.fetch("intersectionBackendClosestHitFrontierHostQueryBytes", 0).to_f
      run_values[:any_hit_frontier_host_query_bytes] +=
        batching.fetch("intersectionBackendAnyHitFrontierHostQueryBytes", 0).to_f
      run_values[:closest_hit_frontier_state_handle_bytes] +=
        batching.fetch("intersectionBackendClosestHitFrontierStateHandleBytes", 0).to_f
      run_values[:any_hit_frontier_state_handle_bytes] +=
        batching.fetch("intersectionBackendAnyHitFrontierStateHandleBytes", 0).to_f
      ...
      run_values[:frontier_compaction_passes] +=
        batching.fetch("frontierCompactionPasses",
                       batching.fetch("frontierHostCompactionPasses", 0)).to_f
      run_values[:frontier_compaction_input_samples] +=
        batching.fetch("frontierCompactionInputSamples",
                       batching.fetch("frontierHostCompactionInputSamples", 0)).to_f
      run_values[:frontier_compaction_retained_samples] +=
        batching.fetch("frontierCompactionRetainedSamples",
                       batching.fetch("frontierHostCompactionRetainedSamples", 0)).to_f
      run_values[:frontier_compaction_removed_samples] +=
        batching.fetch("frontierCompactionRemovedSamples",
                       batching.fetch("frontierHostCompactionRemovedSamples", 0)).to_f
      run_values[:frontier_compaction_moved_samples] +=
        batching.fetch("frontierCompactionMovedSamples",
                       batching.fetch("frontierHostCompactionMovedSamples", 0)).to_f
      run_values[:frontier_compaction_moved_retained_fraction] +=
      ...
      run_values[:frontier_compaction_candidate_host_path_state_bytes] +=
        batching.fetch("frontierCompactionCandidateHostPathStateBytes", 0).to_f
      ...
      run_values[:frontier_largest_compaction_candidate_host_path_state_bytes] =
        [run_values[:frontier_largest_compaction_candidate_host_path_state_bytes],
         batching.fetch("frontierLargestCompactionCandidateHostPathStateBytes", 0).to_f].max
    end
...
%i[frontier_compaction_passes
   ...
   frontier_largest_compaction_candidate_packed_ray_bytes
   frontier_largest_compaction_candidate_state_handle_bytes
   frontier_largest_compaction_candidate_host_path_state_bytes].each do |key|
  reference = median(reference_values[key])
  candidate = median(candidate_values[key])
  delta = candidate - reference
  puts format("%s reference=%.0f candidate=%.0f delta=%.0f",
...
reference = median(reference_values[:frontier_compaction_removed_fraction])
candidate = median(candidate_values[:frontier_compaction_removed_fraction])
puts format("frontier_compaction_removed_fraction reference=%.6f candidate=%.6f delta=%.6f",
            reference, candidate, candidate - reference)
...
def last_array(object, key)
  values = object.fetch(key, [])
  values.empty? ? 0.0 : values.last.to_f
end

def metric_number(object, key, legacy_key, default_value = 0.0)
  object.fetch(key, object.fetch(legacy_key, default_value)).to_f
end
...
def aggregate_run(run)
  ...
  metric_objects_for(run).each do |metrics|
    ...
    values[:active_host_path_state_bytes] +=
      batching.fetch("activeHostPathStateBytesProcessed", 0).to_f
    values[:last_active_host_path_state_bytes] +=
      last_array(batching, "activeHostPathStateBytesPerDepth")
    values[:last_retained_host_path_state_bytes] +=
      last_array(batching, "retainedHostPathStateBytesPerDepth")
    values[:active_hit_host_bytes] += batching.fetch("activeHitHostBytesProcessed", 0).to_f
    ...
    values[:direct_light_any_hit_round_trips] +=
      batching.fetch("directLightAnyHitQueryRoundTrips", 0).to_f
    values[:resident_direct_light_round_trips_estimate] +=
      batching.fetch("residentDirectLightBatchRoundTripsEstimate", 0).to_f
    values[:resident_direct_light_round_trip_savings_estimate] +=
      batching.fetch("residentDirectLightBatchRoundTripSavingsEstimate", 0).to_f
    values[:direct_light_selection_host_bytes] +=
      batching.fetch("directLightSelectionHostBytes", 0).to_f
    values[:direct_light_occlusion_host_bytes] +=
      batching.fetch("directLightOcclusionHostBytes", 0).to_f
    values[:direct_light_contribution_host_bytes] +=
      batching.fetch("directLightContributionHostBytes", 0).to_f
    values[:direct_light_any_hit_frontier_packed_ray_bytes] +=
      batching.fetch("directLightAnyHitFrontierPackedRayBytes", 0).to_f
    values[:direct_light_any_hit_frontier_host_packed_ray_bytes] +=
      batching.fetch("directLightAnyHitFrontierHostPackedRayBytes", 0).to_f
    values[:direct_light_any_hit_frontier_host_query_bytes] +=
      batching.fetch("directLightAnyHitFrontierHostQueryBytes", 0).to_f
    values[:direct_light_any_hit_frontier_state_handle_bytes] +=
      batching.fetch("directLightAnyHitFrontierStateHandleBytes", 0).to_f
    values[:direct_light_any_hit_frontier_last_packed_ray_bytes] +=
      last_array(batching, "directLightAnyHitFrontierPackedRayBytesPerDepth")
    values[:direct_light_any_hit_frontier_last_host_packed_ray_bytes] +=
      last_array(batching, "directLightAnyHitFrontierHostPackedRayBytesPerDepth")
    values[:direct_light_any_hit_frontier_last_host_query_bytes] +=
      last_array(batching, "directLightAnyHitFrontierHostQueryBytesPerDepth")
    values[:direct_light_any_hit_frontier_last_state_handle_bytes] +=
      last_array(batching, "directLightAnyHitFrontierStateHandleBytesPerDepth")
    ...
    values[:resident_frontier_savings] +=
      batching.fetch("frontierResidentQueryRoundTripSavingsEstimate", 0).to_f
    values[:closest_hit_ray_upload_bytes] +=
      batching.fetch("intersectionEstimatedClosestHitRayUploadBytes", 0).to_f
    values[:any_hit_ray_upload_bytes] +=
      batching.fetch("intersectionEstimatedAnyHitRayUploadBytes", 0).to_f
    values[:closest_hit_query_transfer_bytes] +=
      batching.fetch("intersectionEstimatedClosestHitQueryTransferBytes", 0).to_f
    values[:any_hit_query_transfer_bytes] +=
      batching.fetch("intersectionEstimatedAnyHitQueryTransferBytes", 0).to_f
    ...
    values[:any_hit_frontier_packed_ray_bytes] +=
      batching.fetch("intersectionBackendAnyHitFrontierPackedRayBytes", 0).to_f
    values[:closest_hit_frontier_host_packed_ray_bytes] +=
      batching.fetch("intersectionBackendClosestHitFrontierHostPackedRayBytes", 0).to_f
    values[:any_hit_frontier_host_packed_ray_bytes] +=
      batching.fetch("intersectionBackendAnyHitFrontierHostPackedRayBytes", 0).to_f
    values[:closest_hit_frontier_host_query_bytes] +=
      batching.fetch("intersectionBackendClosestHitFrontierHostQueryBytes", 0).to_f
    values[:any_hit_frontier_host_query_bytes] +=
      batching.fetch("intersectionBackendAnyHitFrontierHostQueryBytes", 0).to_f
    values[:closest_hit_frontier_state_handle_bytes] +=
      batching.fetch("intersectionBackendClosestHitFrontierStateHandleBytes", 0).to_f
    values[:any_hit_frontier_state_handle_bytes] +=
      batching.fetch("intersectionBackendAnyHitFrontierStateHandleBytes", 0).to_f
    unless closest_hit_residency.empty?
    ...
    values[:frontier_compaction_passes] +=
      metric_number(batching, "frontierCompactionPasses", "frontierHostCompactionPasses")
    values[:frontier_compaction_input_samples] +=
      metric_number(batching, "frontierCompactionInputSamples",
                    "frontierHostCompactionInputSamples")
    values[:frontier_compaction_retained_samples] +=
      metric_number(batching, "frontierCompactionRetainedSamples",
                    "frontierHostCompactionRetainedSamples")
    values[:frontier_compaction_removed_samples] +=
      metric_number(batching, "frontierCompactionRemovedSamples",
                    "frontierHostCompactionRemovedSamples")
    values[:frontier_compaction_moved_samples] +=
      metric_number(batching, "frontierCompactionMovedSamples",
                    "frontierHostCompactionMovedSamples")
    values[:frontier_compaction_moved_retained_fraction] +=
      batching.fetch("frontierCompactionMovedRetainedSampleFraction", 0).to_f
    ...
    values[:frontier_compaction_candidate_state_handle_bytes] +=
      batching.fetch("frontierCompactionCandidateStateHandleBytes", 0).to_f
    values[:frontier_compaction_candidate_host_path_state_bytes] +=
      batching.fetch("frontierCompactionCandidateHostPathStateBytes", 0).to_f
    ...
    values[:frontier_largest_compaction_candidate_state_handle_bytes] =
      [values[:frontier_largest_compaction_candidate_state_handle_bytes],
       batching.fetch("frontierLargestCompactionCandidateStateHandleBytes", 0).to_f].max
    values[:frontier_largest_compaction_candidate_host_path_state_bytes] =
      [values[:frontier_largest_compaction_candidate_host_path_state_bytes],
       batching.fetch("frontierLargestCompactionCandidateHostPathStateBytes", 0).to_f].max
  ...
  if values[:frontier_compaction_input_samples].positive?
    values[:frontier_compaction_removed_fraction] =
      values[:frontier_compaction_removed_samples] /
      values[:frontier_compaction_input_samples]
  end
  values
...
queue_dirs.each do |queue_dir|
  ...
  Dir.glob(File.join(queue_dir, "wavefront_*.metrics.json")).sort.each do |metrics_path|
    ...
    row = [
      ...
      format("%.0f", median_for.call(:active_host_path_state_bytes)),
      format("%.0f", median_for.call(:last_active_host_path_state_bytes)),
      format("%.0f", median_for.call(:last_retained_host_path_state_bytes)),
      ...
      format("%.0f", median_for.call(:direct_light_any_hit_round_trips)),
      ...
      format("%.0f", median_for.call(:direct_light_occlusion_host_bytes)),
      ...
      format("%.0f", median_for.call(:direct_light_any_hit_frontier_host_packed_ray_bytes)),
      ...
      format("%.0f", median_for.call(:direct_light_any_hit_frontier_last_packed_ray_bytes)),
      format("%.0f", median_for.call(:direct_light_any_hit_frontier_last_host_packed_ray_bytes)),
      format("%.0f", median_for.call(:direct_light_any_hit_frontier_last_host_query_bytes)),
      format("%.0f", median_for.call(:direct_light_any_hit_frontier_last_state_handle_bytes)),
      ...
      format("%.0f", median_for.call(:closest_hit_ray_upload_bytes)),
      format("%.0f", median_for.call(:any_hit_ray_upload_bytes)),
      format("%.0f", median_for.call(:closest_hit_query_transfer_bytes)),
      format("%.0f", median_for.call(:any_hit_query_transfer_bytes)),
      closest_hit_frontier_residency,
      any_hit_frontier_residency,
      ...
      format("%.0f", median_for.call(:closest_hit_frontier_host_packed_ray_bytes)),
      format("%.0f", median_for.call(:any_hit_frontier_host_packed_ray_bytes)),
      format("%.0f", median_for.call(:closest_hit_frontier_host_query_bytes)),
      format("%.0f", median_for.call(:any_hit_frontier_host_query_bytes)),
      format("%.0f", median_for.call(:closest_hit_frontier_state_handle_bytes)),
      ...
      format("%.0f", median_for.call(:frontier_compaction_passes)),
      format("%.0f", median_for.call(:frontier_compaction_input_samples)),
      format("%.0f", median_for.call(:frontier_compaction_retained_samples)),
      format("%.0f", median_for.call(:frontier_compaction_removed_samples)),
      ...
      format("%.0f", median_for.call(:frontier_largest_compaction_candidate_host_path_state_bytes)),
      compaction_execution,
