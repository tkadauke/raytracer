    ...
    RenderViewMode viewModeFromJson(const std::string& value, const std::string& path) {
      return enumValue<RenderViewMode>(
        ...
        {{"default", RenderViewMode::Default},
         ...
         {"sample_stddev", RenderViewMode::SampleStddev},
         {"sample_radiance_stddev", RenderViewMode::SampleStddev},
         {"sample_stddev_color", RenderViewMode::SampleStddevColor},
         {"sample_color_stddev", RenderViewMode::SampleStddevColor},
         {"sample_radiance_stddev_color", RenderViewMode::SampleStddevColor},
  ...
  const char* toString(RenderViewMode value) {
    return enumName<RenderViewMode>(
      value, {{RenderViewMode::Default, "default"},
              ...
              {RenderViewMode::SampleStddev, "sample_stddev"},
