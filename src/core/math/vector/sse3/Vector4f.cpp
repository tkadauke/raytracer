...
const Vector4<float>& Vector4<float>::null() {
  static Vector4<float> v;
  return v;
}

const Vector4<float>& Vector4<float>::epsilon() {
  static Vector4<float> v(numeric_limits<float>::epsilon(),
...
const Vector4<float>& Vector4<float>::undefined() {
  static Vector4<float> v(numeric_limits<float>::quiet_NaN(),
...
const Vector4<float>& Vector4<float>::minusInfinity() {
  static Vector4<float> v(-numeric_limits<float>::infinity(),
