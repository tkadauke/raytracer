...
const Vector4<double>& Vector4<double>::null() {
  static Vector4<double> v;
  return v;
}

const Vector4<double>& Vector4<double>::epsilon() {
  static Vector4<double> v(numeric_limits<double>::epsilon(),
...
const Vector4<double>& Vector4<double>::undefined() {
  static Vector4<double> v(numeric_limits<double>::quiet_NaN(),
...
const Vector4<double>& Vector4<double>::minusInfinity() {
  static Vector4<double> v(-numeric_limits<double>::infinity(),
