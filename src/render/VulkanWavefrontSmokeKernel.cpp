...
namespace render {
  namespace {
#if defined(RAYTRACER_ENABLE_VULKAN_WAVEFRONT)
    class VulkanSmokeRuntime final : public render::detail::VulkanComputeHelper {
    public:
      VulkanSmokeRuntime()
        : VulkanComputeHelper("Vulkan wavefront smoke", "raytracer Vulkan wavefront smoke probe") {}
      ...
      runTimedBasicClosestHitKernel(const GpuIntersectionSceneBuffers& scene,
        ...
        BufferVectorGuard<SmokeBuffer> bufferGuard;
        bufferGuard.device = device;
        ...
        const VkDeviceSize hitByteCount =
          byteCount<GpuIntersectionHitRecord>(rays.size());
        bufferGuard.buffers.push_back(
      ...
      runTimedBasicAnyHitKernel(const GpuIntersectionSceneBuffers& scene,
        ...
        const VkDeviceSize recordByteCount =
          byteCount<GpuIntersectionOcclusionRecord>(rays.size());
        bufferGuard.buffers.push_back(
    ...
    private:
      ...
      using render::detail::VulkanComputeHelper::updateDescriptorSet;
      ...
      void updateDescriptorSet(VkDevice device, VkDescriptorSet descriptorSet,
        ...
        VulkanComputeHelper::updateDescriptorSet(device, descriptorSet, descriptors);
      }
