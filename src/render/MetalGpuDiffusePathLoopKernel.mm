  ...
  namespace {
    ...
    NSString* diffusePathLoopKernelSource() {
      return @"#include <metal_stdlib>\n"
              ...
              "  }\n"
              "  supported = true;\n"
              "  return path.throughput * albedo.parameters * material.parameters.y;\n"
              "}\n"
              ...
              "      float4 continuation = matteContinuationThroughput(\n"
              ...
              "      if (supported) {\n"
              "        bool spawned = false;\n"
              "        next = matteContinuationPath(parameters, hit, path, continuation, spawned);\n"
