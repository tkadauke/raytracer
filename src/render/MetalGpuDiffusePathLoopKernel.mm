  ...
  namespace {
    ...
    NSString* diffusePathLoopKernelSource() {
      return @"#include <metal_stdlib>\n"
              ...
              "          continue;\n"
              "        }\n"
              "        const LocalPrimitiveHit triangleHit = intersectTriangle(\n"
              "            ray, triangles[primitive.payloadOffset], closest.distance);\n"
              "        if (triangleHit.hit) {\n"
              ...
              "          continue;\n"
              "        }\n"
              "        const LocalPrimitiveHit sphereHit = intersectSphere(\n"
              ...
              "          continue;\n"
              "        }\n"
              "        const LocalPrimitiveHit planeHit = intersectPlane(\n"
              "            ray, planes[primitive.payloadOffset], closest.distance);\n"
              "        if (planeHit.hit) {\n"
              ...
              "          continue;\n"
              "        }\n"
              "        const LocalPrimitiveHit rectangleHit = intersectRectangle(\n"
              "            ray, rectangles[primitive.payloadOffset], closest.distance);\n"
              "        if (rectangleHit.hit) {\n"
              ...
              "          continue;\n"
              "        }\n"
              "        const LocalPrimitiveHit diskHit = intersectDisk(\n"
              "            ray, disks[primitive.payloadOffset], closest.distance);\n"
              "        if (diskHit.hit) {\n"
              ...
              "}\n"
              "GpuTracingMaterialRecord materialRecord(\n"
              "    constant GpuDiffusePathLoopLaunchParameters& parameters,\n"
              "    device const uchar* sceneUpload,\n"
              "    uint materialId,\n"
              "    thread bool& supported) {\n"
              ...
              "  supported = false;\n"
              "  if (!materialSupported || material.kind != gpuTracingMatteMaterialKind) {\n"
              "    return float4(0.0f);\n"
              "  }\n"
              "  bool textureSupported = false;\n"
              "  const float4 albedo = constantTextureColor(\n"
              "      parameters, sceneUpload, material.albedoTexture, textureSupported);\n"
              "  if (!textureSupported) {\n"
              "    return float4(0.0f);\n"
              "  }\n"
              "  supported = true;\n"
              ...
              "  }\n"
              "  bool textureSupported = false;\n"
              "  const float4 emitted = constantTextureColor(\n"
              "      parameters, sceneUpload, material.emissionTexture, textureSupported);\n"
              "  if (!textureSupported) {\n"
              "    return float4(0.0f);\n"
              "  }\n"
              "  supported = true;\n"
              ...
              "  return dot(normal, incoming) > 0.0f ? path.throughput * emitted : float4(0.0f);\n"
              "}\n"
              ...
              "      light.kind == gpuTracingRectangularAreaLightKind) {\n"
