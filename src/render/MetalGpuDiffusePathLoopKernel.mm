  ...
  namespace {
    ...
    NSString* diffusePathLoopKernelSourcePrefix() {
      return @"#include <metal_stdlib>\n"
              ...
              "      normalize(pixelPoint.xyz - parameters.primaryPathOrigin.xyz);\n"
              "  const float t = parameters.primaryPathLensParameters.x /\n"
              "                  dot(pinholeDirection,\n"
              "                      normalize(parameters.primaryPathForward.xyz));\n"
              "  const float3 focalPoint = parameters.primaryPathOrigin.xyz + pinholeDirection * t;\n"
              "  const float4 lensOrigin = parameters.primaryPathOrigin +\n"
              ...
              "  const float3 direction = normalize(parameters.primaryPathRight.xyz * local.x +\n"
              "                                     parameters.primaryPathDown.xyz * local.y +\n"
    ...
    NSString* diffusePathLoopKernelSourcePrimaryPathDescriptors() {
      return @"GpuDiffusePathStateRecord makeFishEyePrimaryPath(\n"
              ...
              "  float3 direction = normalize(parameters.primaryPathForward.xyz);\n"
              "  if (valid) {\n"
              ...
              "    direction = normalize(parameters.primaryPathRight.xyz * local.x +\n"
              "                          parameters.primaryPathDown.xyz * local.y +\n"
              "                          parameters.primaryPathForward.xyz * local.z);\n"
              "  }\n"
              "  GpuDiffusePathStateRecord path;\n"
              ...
              "  const float3 pinholeDirection =\n"
              "      normalize(shiftedPixelPoint - parameters.primaryPathOrigin.xyz);\n"
              ...
              "  float3 focalPoint = parameters.primaryPathOrigin.xyz;\n"
              "  if (valid) {\n"
              "    const float numerator = parameters.primaryPathLensParameters.x *\n"
              "                            dot(focalForward, tiltedNormal);\n"
              "    focalPoint = parameters.primaryPathOrigin.xyz +\n"
