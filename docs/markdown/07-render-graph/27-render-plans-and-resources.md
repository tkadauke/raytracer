...
## 27.1 The vocabulary lives in one place
...
## 27.2 Intent describes what the user asked for
...
## 27.3 Resources are descriptors, not buffers
...
## 27.4 Pass nodes declare reads and writes
...
## 27.5 Validation catches graph mistakes
...
## 27.6 Exports make the plan inspectable
...
## 27.7 Overrides disable by id, kind, executor, or feature
...
- Volume index: [Volume VII — Render graph](README.md)
- Previous volume:
  [Volume VI — Tools & I/O](../06-tools-and-io/README.md)
- Next volume:
  [Volume VIII — Animation](../08-animation/README.md)
