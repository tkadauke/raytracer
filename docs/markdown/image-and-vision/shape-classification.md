...
## <a id="the-two-predicates"></a>The two predicates
[`ShapeClassifier`](../../../test/helpers/ShapeClassifier.h)
...
## <a id="why-radial-variance-is-the-right-descriptor"></a>Why radial variance is the right descriptor
...
[Blob analysis and silhouettes: What a blob carries](blob-analysis-and-silhouettes.md#what-a-blob-carries) —
...
## <a id="the-iscircle-decision-boundary"></a>The `isCircle` decision boundary
...
The **radial variance threshold** is `< 0.10`. From
[Why radial variance is the right descriptor](#why-radial-variance-is-the-right-descriptor),
...
## <a id="the-isrectangle-decision-boundary"></a>The `isRectangle` decision boundary
...
## <a id="pushing-the-descriptors-across-the-boundary"></a>Pushing the descriptors across the boundary
...
## <a id="why-two-predicates-not-one"></a>Why two predicates, not one
...
## <a id="what-the-classifier-doesn-t-catch"></a>What the classifier doesn't catch
...
- Next volume: [Tools & I/O](../tools-and-io/README.md)
- [Silhouette](../appendix/a-glossary.md#s) source:
  [The `Silhouette` shortcut](blob-analysis-and-silhouettes.md#the-silhouette-shortcut)
