...
time, OpenGL setup and draw-submission time, prepared vertex/index upload byte
counts, and the current eager color/depth/stencil readback time. Beauty, depth
AOV, and stencil AOV passes all publish those OpenGL timing messages. OpenGL
