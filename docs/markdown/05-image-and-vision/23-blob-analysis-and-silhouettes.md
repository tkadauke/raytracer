...
## 23.1 Connected components: flood fill
...
the classifier in chapter 24 work uniformly across all three
rendering engines.

## 23.4 The `Silhouette` shortcut
...
## 23.5 Picking between Blob and Silhouette
...
## 23.6 What this chapter does *not* cover

Several connected-components extensions live under roadmap
§4.11.d:
...
- Buffer iteration:
  [22. Image buffers and pixel formats §22.2](22-image-buffers-and-pixel-formats.md#22-2-the-standard-iteration-pattern)
