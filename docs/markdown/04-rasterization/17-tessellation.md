...
The raytracer in Volume II works on **implicit surfaces** — a
...
matters for smooth shading (chapter 18 describes how the
...
## 17.5 Open cylinder: quad strip with seam-duplicate UVs
...
both dimensions getting the seam duplication from §17.5. The
...
## 17.9 Instances: transform vertex points and normals
...
([chapter 16 §16.4](../03-scene-structure/16-instances-and-motion-blur.md#16-4-velocity-and-motion-blur)),
...
## 17.10 Picking a level of detail
...
([chapter 20](20-wireframe-rendering.md)) is the LOD-tuning
...
- Instance transform math:
  [2. Matrices and transforms §2.6](../01-foundations/02-matrices-and-transforms.md#2-6-the-four-matrix-dance-instance)
