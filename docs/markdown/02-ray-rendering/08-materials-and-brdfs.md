...
[chapter 5 §5.3](05-the-whitted-pipeline.md#5-3-the-renderengine-abstraction)
...
(§8.5), and casting shadow rays via `scene.intersects(...)`. The
...
[chapter 5 §5.5](05-the-whitted-pipeline.md#5-5-the-per-ray-state),
...
## 8.4 The five shipped materials
...
[chapter 5 §5.1](05-the-whitted-pipeline.md#5-1-the-algorithm-in-one-paragraph).
...
## 8.6 The four BRDFs and four (plus one) materials, summarized
...
- Recursive call back into the renderer:
  [5. The Whitted pipeline §5.4](05-the-whitted-pipeline.md#5-4-the-recursive-heart)
