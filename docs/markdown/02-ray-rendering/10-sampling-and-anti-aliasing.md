...
## 10.1 Aliasing as undersampling
...
## 10.3 The stratification invariant
...
## 10.4 Two access patterns: sets and streams
...
([chapter 6 §6.5](06-cameras.md#6-5-thin-lens-depth-of-field))
...
## 10.5 The thin-lens / sampler interaction

Chapter 6 introduced the thin-lens camera and noted that it
...
## 10.8 What this chapter does *not* cover
...
- Stream-API consumer:
  [6. Cameras §6.5](06-cameras.md#6-5-thin-lens-depth-of-field)
- Set-API consumer:
