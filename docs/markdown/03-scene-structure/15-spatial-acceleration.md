...
## 15.3 The Surface Area Heuristic
...
## 15.4 The uniform grid alternative
...
educational alternative, and the codebase will probably grow
more acceleration structures (kd-trees, octrees) over time —
queued under roadmap §4.2.b.

## 15.6 Acceleration is invisible at the pixel level
...
## 15.7 What this chapter does *not* cover

Several acceleration structures are queued under roadmap
§4.2.b:
...
- Previous:
  [14. Constructive solid geometry](14-csg.md)
- Next:
  [16. Instances and motion blur](16-instances-and-motion-blur.md)
- Bounding-box vocabulary:
  [3. Rays and geometry §3.6](../01-foundations/03-rays-and-geometry.md#3-6-bounding-boxes)
