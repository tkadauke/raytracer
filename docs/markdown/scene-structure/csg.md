...
## <a id="hit-intervals-are-the-unifying-abstraction"></a>Hit intervals are the unifying abstraction
...
## <a id="the-three-boolean-operations"></a>The three Boolean operations
...
## <a id="convex-composites-support-mapping"></a>Convex composites: support mapping
...
## <a id="gjk-ray-intersection-on-a-support-function"></a>GJK: ray intersection on a support function
...
## <a id="closedsolidunion-the-workaround"></a>`ClosedSolidUnion` — the workaround
...
## <a id="tessellation-is-not-yet-supported"></a>Tessellation is not yet supported
...
The codebase punts on this. CSG primitives render
correctly under the raytracer (where intersection works on hit
intervals, not on triangle data) but render as empty in the
rasterizer / wireframe engines.

## <a id="picking-a-composite"></a>Picking a composite
...
- Previous: [View planes](view-planes.md)
- Next: [Spatial acceleration](spatial-acceleration.md)
- [HitPointInterval](../appendix/a-glossary.md#h) vocabulary:
  [`HitPointInterval`: in / out / in / out](../foundations/rays-and-geometry.md#hitpointinterval-in-out-in-out)
