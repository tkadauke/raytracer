...
## <a id="why-hdr-exists"></a>Why HDR exists
...
## <a id="the-tonemap-interface"></a>The `Tonemap` interface
The base class is
...
## <a id="linear-pass-through-hard-clamp"></a>Linear (pass-through, hard clamp)
...
([Color and buffers: HDR vs LDR](../foundations/color-and-buffers.md#hdr-vs-ldr)),
...
## <a id="reinhard-compressed-everywhere"></a>Reinhard (compressed everywhere)
...
## <a id="aces-filmic-ish-punchy-midtones"></a>ACES (filmic-ish, punchy midtones)
...
## <a id="the-cross-operator-ordering-invariant"></a>The cross-operator ordering invariant
...
## <a id="the-gamma-encode"></a>The gamma encode
...
described in [Color and buffers](../foundations/color-and-buffers.md).
A correct renderer would do the gamma
...
## <a id="picking-a-tonemap"></a>Picking a tonemap
...
- Previous: [Textures](textures.md)
- Next volume:
  [Scene structure](../scene-structure/README.md)
- Buffer foundation:
  [Color and buffers](../foundations/color-and-buffers.md)
- Linear-vs-sRGB invariant:
  [Linear RGB vs sRGB](../foundations/color-and-buffers.md#linear-rgb-vs-srgb)
