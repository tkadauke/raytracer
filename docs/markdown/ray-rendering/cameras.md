...
## <a id="the-camera-interface"></a>The `Camera` interface
...
- a **view plane** (covered in
  [View planes](../scene-structure/view-planes.md) — the 2D
...
[Lights and shading](lights-and-shading.md) uses it to translate
...
## <a id="pinhole-the-canonical-case"></a>Pinhole: the canonical case
...
## <a id="orthographic-parallel-projection"></a>Orthographic: parallel projection
...
The view-plane vocabulary applies unchanged; the
...
## <a id="wide-angle-spherical-fisheye-equirectangular"></a>Wide-angle: spherical, fisheye, equirectangular
...
## <a id="thin-lens-depth-of-field"></a>Thin-lens: depth of field
...
## <a id="tilt-shift-a-tilted-focal-plane"></a>Tilt-shift: a tilted focal plane
...
- Previous: [The Whitted pipeline](the-whitted-pipeline.md)
- Next: [Primitives and intersection](primitives-and-intersection.md)
- Sampler interaction:
  [Sampling and anti-aliasing](sampling-and-anti-aliasing.md)
  — the multi-sample requirement for thin-lens
- View plane:
  [View planes](../scene-structure/view-planes.md) — the
