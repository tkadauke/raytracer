...
every primitive has an eight-wide materialization kernel; the packet
scalar-fallback metric intentionally reports the remaining leaf gaps so the next
performance slices can target them directly.
